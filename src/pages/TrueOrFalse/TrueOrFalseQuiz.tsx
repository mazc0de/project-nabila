...
const TrueOrFalseQuiz = () => {
  ...
  return (
    <>
      <div className="mx-auto flex h-screen w-full flex-col items-center justify-center bg-cover bg-center p-5 lg:w-[550px]">
        <div className="shadow-card__generic-structure flex h-auto w-full flex-col items-center justify-center rounded-lg bg-off-white-100 p-3">
          <div className="mb-3">
          ...
          <div className="mb-3 flex">
            <div className="mr-3">
              ...
              >
                ...
                <p className="font-moreSugar text-sm lg:text-lg">TRUE</p>
              </div>
            </div>
            <div className="ml-3">
              <div
              ...
              >
                <img
                  src={icons.THUMB_DOWN}
                  alt="thumb-up"
                  className="h-5 w-5"
                />
                <p className="font-moreSugar text-sm lg:text-lg">FALSE</p>
              </div>
            </div>
          </div>
